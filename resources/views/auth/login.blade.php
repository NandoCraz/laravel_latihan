...
<div class="container">
    ...
    <!-- <div class="row justify-content-center">
        <div class="col-md-6">
        <img src="{{asset('image/keyR.png')}}" style="width: 350px; height: 350px; margin: 0 auto; border-radius: 50%">
        </div>
        <div class="col-md-6">
            <div class="card" style="margin-top: 20px">
                <div class="card-header text-center"><img src="{{asset('image/loginR.png')}}" style="width: 90px; height: 90px"></div>
