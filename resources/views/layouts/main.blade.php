...
<div class="wrapper d-flex align-items-strech">
    ...
    <div class="navigation">
        <ul>
            ...
            <li>
                <a href="/angkatan">
                    ...
                    <span class="title">Data Angkatan Kelas</span>
                </a>
            </li>
            <li>
                <a href="/kelas">
                    ...
                    <div class="title">Data Ruangan</div>
                </a>
            </li>
            <li>
                <a href="/walkel">
                    ...
                    <div class="title">Data Wali Kelas</div>
                </a>
            </li>
            <li>
                <a href="/user">
        ...
        <div class="logout">
                <a class="btn" style="padding:0; color:white" href="{{ route('logout') }}"
